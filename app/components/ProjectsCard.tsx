            ...
            <div className='flex flex-col mt-10 print:mt-0 gap-10'>
                <div className='print:border-b-1 break-inside-avoid'>
                    <GitHubRepoItem
                        ...
                        siteDescription={
                            <div className='min-h-30 print:min-h-auto print:mb-5'>
                                {t('projectsCard.projectRepos.podcastAutoCleanCli.siteDescription')}
                            </div>
                        }
                    />
                </div>
                <div className='print:border-b-1 break-inside-avoid'>
                    <GitHubRepoItem
                        ...
                        siteDescription={
                            <div className='min-h-20 print:min-h-auto print:mb-5'>
                                {t('projectsCard.projectRepos.game.siteDescription')}
                            </div>
                        }
                        siteBanner={
                            <HoverVideo
                                posterSrc='game-banner-frame-0.webp'
                                videoSrc='game-banner.webm'
                                alt='Game Banner'
                                className='h-full'
                            />
                        }
                ...
                <div className='print:border-b-1 break-inside-avoid'>
                    <GitHubRepoItem
                        ...
                        siteDescription={
                            <div className='min-h-20 print:min-h-auto print:mb-5'>
                                {t('projectsCard.projectRepos.dustpressDebugger.siteDescription')}
                            </div>
                        }
                    />
                </div>
                <div className='break-inside-avoid'>
                    <GitHubRepoItem
                        ...
                        siteDescription={
                            <div className='min-h-20 print:min-h-auto'>
                                {t('projectsCard.projectRepos.cv.siteDescription')}
                            </div>
                        }
                    />
                </div>
